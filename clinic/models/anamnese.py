...
class Anamnese(models.Model):
    ...
    intestino = models.CharField(max_length=100, verbose_name="Intestino?")
    aversao = models.CharField(max_length=100, verbose_name="Aversão?")
    organizacao = models.TextField(verbose_name="Como pretende se organizar?")
    historico_peso = models.TextField(verbose_name="Histórico de Evolução de Peso")
    nome = models.CharField(max_length=100, verbose_name="Nome")
    cidade = models.CharField(max_length=100, verbose_name="Cidade")
    estado = models.CharField(max_length=2, verbose_name="Estado")
    profissao = models.CharField(max_length=100, verbose_name="Profissão")
    idade = models.IntegerField(verbose_name="Idade")
    toma_agua = models.CharField(max_length=100, verbose_name="Toma água?")
    medicamentos = models.CharField(max_length=100, verbose_name="Medicamentos?")
    sono = models.CharField(max_length=100, verbose_name="Sono?")
    doenca_intolerancia = models.CharField(max_length=100, verbose_name="Doença/Intolerância?")
